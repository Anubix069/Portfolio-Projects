...
# -----------------------------------------------------------
    ...
    st.markdown("""
    Ce projet met en lumière l'évolution du réchauffement climatique à travers les anomalies de température et les émissions de CO2. Il est évident que le réchauffement climatique a un impact significatif sur la planète, et les émissions de CO2 restent un facteur clé dans ce phénomène. Depuis les années 80, une accélération de ces anomalies a été observée, en corrélation avec une hausse des émissions de CO2, surtout dans les pays en développement. Cependant, des efforts notables ont été réalisés dans certaines régions, notamment en Europe et aux États-Unis, pour favoriser la transition vers des énergies renouvelables et réduire l'empreinte carbone.
